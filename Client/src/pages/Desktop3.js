...
const Desktop3 = () => {
  return (
    <div className="w-full h-[64rem] relative bg-white overflow-hidden flex flex-row items-start justify-center pt-[4.19rem] pb-[56.13rem] pr-[1.31rem] pl-[1.25rem] box-border">
      <HomeContainer
        frameNavigationFlex="unset"
        frameNavigationWidth="74.56rem"
        frameNavigationGap="unset"
