...
const ContainerCardFormFilter1 = ({ imageDimensions }) => {
  return (
    <div className="w-[23.31rem] shrink-0 flex flex-row items-start justify-start relative text-center text-[1.75rem] text-black font-poppins">
      <img
        ...
        src={imageDimensions}
      />
      <div className="flex-1 rounded-xl bg-white shadow-[2px_2px_100px_rgba(0,_0,_0,_0.2)] flex flex-col items-center justify-start pt-[17.75rem] pb-[1.56rem] pr-[1.94rem] pl-[1.75rem] box-border gap-[0.75rem] max-w-full mq750:pt-[11.56rem] mq750:pb-[1.25rem] mq750:box-border">
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[1.06rem]">
          ...
          <div className="self-stretch h-[8.13rem] relative text-[1.13rem] leading-[1.63rem] font-light text-dark-content text-left flex items-center z-[1]">
            This is sample project description random things are here in
            description This is sample project lorem ipsum generator for dummy
            content
          </div>
        </div>
        <div className="self-stretch flex flex-col items-start justify-start gap-[1.31rem] text-left text-[1rem] text-solid-heading">
          ...
          <div className="flex flex-row items-start justify-start gap-[3rem] text-black mq450:flex-wrap">
